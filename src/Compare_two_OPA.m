...
title('The AF over -90 and 90 degree with 56.6 filling rate')

AF_opt_narrow = AF(elementPos,leftend,rightend,Res,k,ang,true,wopt);
title('The AF over the region of interest (-20,20) with ')
figure
...
wopt = [woptl;woptr];      
AF_opt = AF(elementPos,-90,90,30000,k,ang,true,wopt);
title('The AF over -90 and 90 degree with 65.33 filling rate')
